...
- Elegí una interfaz simple para ir familiarizandome con los conceptos y facilitar la comprensión de lo que me estaban solicitando. Tiene un fondo, una tarjeta con un título, un texto y un boton cuyo código extraje de ejemplo de w3 school 
