...
- Elegí una interfaz simple para ir familiarizandome con los conceptos y facilitar la comprensión de lo que me estaban solicitando.
-Use colores opuestos, el modo claro un fondo blanco y el oscuro en gris medio, fui probando en el css color por color 
- Se separó la tarjeta en un componente aparte para cumplir con la estructura de componentes pedida en la pauta.
- Se utilizó CSS externo para mantener más ordenado el código y separar la lógica de la presentación.
